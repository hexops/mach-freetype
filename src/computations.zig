...
pub fn mulDiv(a: i32, b: i32, c: i32) i32 {
    return @intCast(_c.FT_MulDiv(a, b, c));
}

pub fn mulFix(a: i32, b: i32) i32 {
    return @intCast(_c.FT_MulFix(a, b));
}

pub fn divFix(a: i32, b: i32) i32 {
    return @intCast(_c.FT_DivFix(a, b));
}

pub fn roundFix(a: i32) i32 {
    return @intCast(_c.FT_RoundFix(a));
}

pub fn ceilFix(a: i32) i32 {
    return @intCast(_c.FT_CeilFix(a));
}

pub fn floorFix(a: i32) i32 {
    return @intCast(_c.FT_FloorFix(a));
}
...
pub fn angleDiff(a: i32, b: i32) i32 {
    return @intCast(_c.FT_Angle_Diff(a, b));
}
...
pub fn vectorLength(vec: *Vector) i32 {
    return @intCast(_c.FT_Vector_Length(vec));
}
